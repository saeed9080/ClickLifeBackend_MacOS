...
const createComplain = async (req, res) => {
    try {
        ...
        const { loginType, client, phone, dep_name,username, description,country  } = req.body;  // Assuming loginType is passed in the request body
...
const issuesolved = async (req, res) => {
    try {
        ...
        const {status, client, country, username} = req.body;
